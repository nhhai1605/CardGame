...
public interface GameEngine
{
	...
	/**
	 * <pre>
	 * Same as dealPlayer() other than the two notes below but deals for the house and calls the
	...
	/**
	 * <b>NOTE:</b> id is unique and if another player with same id is added it
	...
	/**
	 * the implementation should forward the call to the player class so the bet is
	 * set per player
	 * 
	 ...
	 * @return true if the player had sufficient points and the bet was valid and
	 *         placed
	 */
	 ...
	 * 
	 *                           <pre>
	 *  a client specific implementation of GameEngineCallback used to perform display updates etc.
	 ...
	 * Collection is SORTED in ascending order by player id
	 * </pre>
	 * 
	...
	/**
	 * A debug method to return a "HALF" deck of cards containing 28 unique cards (8
	 * through to Ace) in<br>
	 * random/shuffled order (i.e. should return a new deck that is random WRT
	 * previous one)
	 * 
